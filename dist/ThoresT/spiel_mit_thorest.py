"""PacmanGame.py mit ThoresT in der Aufstellung.

Identisch zur Datei des Lehrers, bis auf zwei Zeilen: der Import und ein
Eintrag in ``pacmans``. ``PacmanGame.py`` selbst bleibt unangetastet.

    python spiel_mit_thorest.py        (braucht pygame)
"""
...
from ThoresT import ThoresT          # <- dazu
